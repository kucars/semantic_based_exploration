...
#ifndef INFORMATIONGAINAVERAGEENTROPY_HPP_
#define INFORMATIONGAINAVERAGEENTROPY_HPP_
#include <thread>
#include <chrono>
#include <cstdlib>
...
rrtNBV::InformationGainAverageEntropy::InformationGainAverageEntropy()
  : rrtNBV::InformationGainBase::InformationGainBase()
{}

rrtNBV::InformationGainAverageEntropy::InformationGainAverageEntropy(mesh::StlMesh * mesh, volumetric_mapping::OctomapManager * manager)
{
  mesh_ = mesh;
  manager_ = manager;
  kdTree_ = kd_create(3);
...
void rrtNBV::InformationGainAverageEntropy::initialize()
{
  ROS_WARN("tree Inotilization");
...
bool rrtNBV::InformationGainAverageEntropy::iterate(int iterations)
{
...
double rrtNBV::InformationGainAverageEntropy::gain(StateVec state)
{
  visualization_msgs::Marker p;
  // This function computes the gain
  double gain = 0.0;
  double NumberOfVoxelsInoneView = 0 ;
