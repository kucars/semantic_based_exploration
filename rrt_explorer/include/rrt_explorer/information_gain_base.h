...
#ifndef INFORMATIONGAINBASE_H_
#define INFORMATIONGAINBASE_H_
...
class InformationGainBase : public TreeBase
{
 public:
  InformationGainBase();
  InformationGainBase(mesh::StlMesh * mesh, volumetric_mapping::OctomapManager * manager);
  ~InformationGainBase();
  ...
  double getBestGain() ;
  geometry_msgs::Pose getBestEdgePoint(std::string targetFrame);
